...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "CommerciumX.ipc", false, filepath.Join(os.TempDir(), "CommerciumX.ipc")},
		{"data", "CommerciumX.ipc", false, "data/CommerciumX.ipc"},
		{"data", "./CommerciumX.ipc", false, "./CommerciumX.ipc"},
		{"data", "/CommerciumX.ipc", false, "/CommerciumX.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "CommerciumX.ipc", true, `\\.\pipe\CommerciumX.ipc`},
		{"data", "CommerciumX.ipc", true, `\\.\pipe\CommerciumX.ipc`},
		{"data", `\\.\pipe\CommerciumX.ipc`, true, `\\.\pipe\CommerciumX.ipc`},
	}
