...
// Package bind generates CommerciumX contract Go bindings.
//
// Detailed usage document and tutorial available on the go-CommerciumX Wiki page:
// https://github.com/CommerciumBlockchain/go-CommerciumX/wiki/Native-DApps:-Go-bindings-to-CommerciumX-contracts
package bind
