...
import (
	...
	ethereum "github.com/CommerciumBlockchain/go-CommerciumX"
...
type driver interface {
	...
	// Derive sends a derivation request to the USB device and returns the CommerciumX
...
func (w *wallet) selfDerive() {
	...
	for errc == nil && err == nil {
		...
		for empty := false; !empty; {
			// Retrieve the next derived CommerciumX account
