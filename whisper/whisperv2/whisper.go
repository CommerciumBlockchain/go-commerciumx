...
import (
	...
	"github.com/CommerciumBlockchain/go-CommerciumX/crypto/ecies"
	"github.com/CommerciumBlockchain/go-CommerciumX/event/filter"
...
// Whisper represents a dark communication interface through the CommerciumX
...
// New creates a Whisper client ready to communicate through the CommerciumX P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
