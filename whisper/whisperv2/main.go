...
import (
	...
	"github.com/CommerciumBlockchain/go-CommerciumX/logger"
	"github.com/CommerciumBlockchain/go-CommerciumX/p2p"
	"github.com/CommerciumBlockchain/go-CommerciumX/p2p/nat"
	"github.com/CommerciumBlockchain/go-CommerciumX/whisper"
)
...
func main() {
	...
	// Create an CommerciumX peer to communicate through
	server := p2p.Server{
		PrivateKey: key,
		MaxPeers:   10,
		Name:       name,
	...
	fmt.Println("Starting CommerciumX peer...")
	if err := server.Start(); err != nil {
		fmt.Printf("Failed to start CommerciumX peer: %v.\n", err)
		os.Exit(1)
	}
