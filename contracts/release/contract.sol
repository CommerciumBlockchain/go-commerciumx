...
// ReleaseOracle is an CommerciumX contract to store the current and previous
// versions of the go-CommerciumX implementation. Its goal is to allow CommerciumX to
// check for new releases automatically without the need to consult a central
// repository.
//
// The contract takes a vote based approach on both assigning authorised signers
// as well as signing off on new CommerciumX releases.
//
...
contract ReleaseOracle {
  ...
  // Version is the version details of a particular CommerciumX release
  struct Version {
  ...
  // updateSigner marks a vote for changing the status of an CommerciumX user, either
