...
type Config struct {
	Oracle common.Address // CommerciumX address of the release oracle
...
func NewReleaseService(ctx *node.ServiceContext, config Config) (node.Service, error) {
	// Retrieve the CommerciumX service dependency to access the blockchain
	var apiBackend ethapi.Backend
	var ethereum *eth.CommerciumX
...
func (r *ReleaseService) checkVersion() {
	...
	if version.Major > r.config.Major ||
		...
		howtofix := fmt.Sprintf("Please check https://github.com/CommerciumBlockchain/go-CommerciumX/releases for new releases")
