Name "cmmx ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/CommerciumBlockchain/go-CommerciumX/issues"
!define UPDATEURL "https://github.com/CommerciumBlockchain/go-CommerciumX/releases"
!define ABOUTURL "https://github.com/CommerciumBlockchain/go-CommerciumX#ethereum-go"
...
# Install cmmx binary
Section "CommerciumX" CommerciumX_IDX
  SetOutPath $INSTDIR
  file {{.CommerciumX}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\cmmx.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\cmmx.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "CommerciumX incoming peers (TCP:13373)"
  SimpleFC::AdvRemoveRule "CommerciumX outgoing peers (TCP:13373)"
  SimpleFC::AdvRemoveRule "CommerciumX UDP discovery (UDP:13373)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "CommerciumX incoming peers (TCP:13373)" ""  6 1 1 2147483647 1 "$INSTDIR\cmmx.exe" "" "" "CommerciumX" 13373 "" "" ""
  SimpleFC::AdvAddRule "CommerciumX outgoing peers (TCP:13373)" ""  6 2 1 2147483647 1 "$INSTDIR\cmmx.exe" "" "" "CommerciumX" "" 13373 "" ""
  SimpleFC::AdvAddRule "CommerciumX UDP discovery (UDP:13373)" "" 17 2 1 2147483647 1 "$INSTDIR\cmmx.exe" "" "" "CommerciumX" "" 13373 "" ""

  # Set default IPC endpoint (https://github.com/CommerciumBlockchain/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\CommerciumX.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\CommerciumX.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${CommerciumX_IDX}
    SectionGetSize ${CommerciumX_IDX} $0
