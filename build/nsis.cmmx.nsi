...
# 1. install cmmx for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for cmmx
# 5. create cmmx, attach and uninstall start menu entries
...
!define GROUPNAME "CommerciumX"
!define APPNAME "CommerciumX"
!define DESCRIPTION "Official Go implementation of the CommerciumX protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since cmmx is installed global
