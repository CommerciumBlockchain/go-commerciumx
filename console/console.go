...
import (
	...
	"github.com/CommerciumBlockchain/go-CommerciumX/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client  // RPC client to execute CommerciumX requests through
...
func (c *Console) init(preload []string) error {
	...
	flatten := "var eth = web3.eth; var cmmx = web3.eth; var personal = web3.personal; "
	for api := range apis {
		if api == "web3" {
...
// Welcome show summary of current CommerciumX instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic CommerciumX metadata
	fmt.Fprintf(c.printer, "Welcome to the CommerciumX JavaScript console!\n\n")
	c.jsre.Run(`
