// Copyright 2018 The go-ethereum Team
// This file is part of go-CommerciumX.
//
// go-CommerciumX is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version.
//
// go-CommerciumX is distributed in the hope that it will be useful,
// but WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
// GNU General Public License for more details.
//
// You should have received a copy of the GNU General Public License
// along with go-CommerciumX. If not, see <http://www.gnu.org/licenses/>.
...
import (
	...
	"github.com/CommerciumBlockchain/go-CommerciumX/accounts/keystore"
	...
	"github.com/CommerciumBlockchain/go-CommerciumX/eth"
	"github.com/CommerciumBlockchain/go-CommerciumX/eth/downloader"
	"github.com/CommerciumBlockchain/go-CommerciumX/ethclient"
	"github.com/CommerciumBlockchain/go-CommerciumX/ethstats"
	"github.com/CommerciumBlockchain/go-CommerciumX/les"
	...
	"github.com/CommerciumBlockchain/go-CommerciumX/p2p/discover"
	"github.com/CommerciumBlockchain/go-CommerciumX/p2p/discv5"
	"github.com/CommerciumBlockchain/go-CommerciumX/p2p/nat"
...
var (
	...
	ethPortFlag = flag.Int("ethport", 13373, "Listener port for the devp2p connection")
	bootFlag    = flag.String("bootnodes", "", "Comma separated bootnode enode URLs to seed with")
	netFlag     = flag.Uint64("network", 0, "Network ID to use for the CommerciumX protocol")
	...
	logFlag    = flag.Int("loglevel", 3, "Log level to use for CommerciumX and the faucet")
)
...
type request struct {
	...
	Account common.Address     `json:"account"` // CommerciumX address being funded
	Time    time.Time          `json:"time"`    // Timestamp when the request was accepted
	Tx      *types.Transaction `json:"tx"`      // Transaction funding the account
}

// faucet represents a crypto faucet backed by an CommerciumX light client.
type faucet struct {
	config *params.ChainConfig // Chain configurations for signing
	stack  *node.Node          // CommerciumX protocol stack
	client *ethclient.Client   // Client connection to the CommerciumX chain
...
func newFaucet(genesis *core.Genesis, port int, enodes []*discv5.Node, network uint64, stats string, ks *keystore.KeyStore, index []byte) (*faucet, error) {
	...
	// Assemble the CommerciumX light client protocol
...
// close terminates the CommerciumX connection and tears down the faucet.
...
func (f *faucet) apiHandler(conn *websocket.Conn) {
	...
	for {
		...
		// Retrieve the CommerciumX address to fund, the requesting user and a profile picture
		var (
			username string
			avatar   string
		...
		default:
			err = errors.New("Something funky happened, please open an issue at https://github.com/CommerciumBlockchain/go-CommerciumX/issues")
		}
		if err != nil {
			if err = sendError(conn, err); err != nil {
...
// the username, avatar URL and CommerciumX address to fund on success.
func authGitHub(url string) (string, string, common.Address, error) {
	...
	// Iterate over all the files and look for CommerciumX addresses
	...
	if address == (common.Address{}) {
		return "", "", common.Address{}, errors.New("No CommerciumX address found to fund")
	}
...
func authTwitter(url string) (string, string, common.Address, error) {
	...
	// scrape it for the CommerciumX address and profile URL.
...
// returning the username, avatar URL and CommerciumX address to fund on success.
...
// authNoAuth tries to interpret a faucet request as a plain CommerciumX address,
