...
type wizard struct {
	...
	services map[string][]string   // CommerciumX services known to be running on servers
...
// converts it to an CommerciumX address. If an empty line is entered, the default
// value is returned.
