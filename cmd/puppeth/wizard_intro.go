...
// setting up a new or managing an existing CommerciumX private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your CommerciumX private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new CommerciumX network down to  |")
	...
	log.Info("Administering CommerciumX network", "name", w.network)
