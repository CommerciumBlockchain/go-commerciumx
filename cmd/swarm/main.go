...
import (
	...
	"github.com/CommerciumBlockchain/go-CommerciumX/cmd/utils"
	"github.com/CommerciumBlockchain/go-CommerciumX/common"
	"github.com/CommerciumBlockchain/go-CommerciumX/console"
	"github.com/CommerciumBlockchain/go-CommerciumX/contracts/ens"
	"github.com/CommerciumBlockchain/go-CommerciumX/crypto"
	"github.com/CommerciumBlockchain/go-CommerciumX/ethclient"
	"github.com/CommerciumBlockchain/go-CommerciumX/internal/debug"
	...
	"github.com/CommerciumBlockchain/go-CommerciumX/swarm"
	bzzapi "github.com/CommerciumBlockchain/go-CommerciumX/swarm/api"
)
...
var (
	...
	SwarmSwapAPIFlag = cli.StringFlag{
		Name:   "swap-api",
		Usage:  "URL of the CommerciumX API provider to use to settle SWAP payments",
	...
	EnsAPIFlag = cli.StringFlag{
		Name:   "ens-api",
		Usage:  "URL of the CommerciumX API provider to use for ENS record lookups",
...
// This init function sets defaults so cmd/swarm can run alongside cmmx.
func init() {
...
var app = utils.NewApp(gitCommit, "CommerciumX Swarm")

// This init function creates the cli.App.
func init() {
	app.Action = bzzd
	app.HideVersion = true // we have a command to print the version
	app.Copyright = "Copyright 2013-2018 The go-ethereum Team"
...
Export a local chunk database as a tar archive (use - to send to stdout).
    ...
    swarm db export ~/.CommerciumX/swarm/bzz-KEY/chunks chunks.tar

The export may be quite large, consider piping the output through the Unix
pv(1) tool to get a progress bar:

    swarm db export ~/.CommerciumX/swarm/bzz-KEY/chunks - | pv > chunks.tar
`,
				},
				{
					Action:    dbImport,
...
Import chunks from a tar archive into a local chunk database (use - to read from stdin).
    ...
    swarm db import ~/.CommerciumX/swarm/bzz-KEY/chunks chunks.tar

The import may be quite large, consider piping the input through the Unix
pv(1) tool to get a progress bar:

    pv chunks.tar | swarm db import ~/.CommerciumX/swarm/bzz-KEY/chunks -
`,
				},
				{
					Action:    dbClean,
...
func bzzd(ctx *cli.Context) error {
	...
	//cmmx only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for cmmx and swarm
