...
// all blocks' seal as valid, though they still have to conform to the CommerciumX
// consensus rules.
...
// still have to conform to the CommerciumX consensus rules.
...
// they still have to conform to the CommerciumX consensus rules.
