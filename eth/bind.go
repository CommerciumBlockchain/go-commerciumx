...
import (
	...
	"github.com/CommerciumBlockchain/go-CommerciumX"
...
// ContractBackend implements bind.ContractBackend with direct calls to CommerciumX
// internals to support operating on contracts within subprotocols like eth and
// swarm.
//
// Internally this backend uses the already exposed API endpoints of the CommerciumX
// object. These should be rewritten to internal Go method calls when the Go API
// is refactored to support a clean library use.
type ContractBackend struct {
	eapi  *ethapi.PublicEthereumAPI        // Wrapper around the CommerciumX object to access metadata
...
// ContractCall implements bind.ContractCaller executing an CommerciumX contract
